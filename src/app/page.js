  ...
  return (
    <>
      ...
      >
        <section
          id="home"
          className="relative z-10 w-full min-h-screen flex flex-col justify-center items-center py-24 overflow-hidden"
        >
          <MeshBackground />
          <motion.div
        ...
        <div className="section-divider">
          ...
          >
            <path
              d="M0 40 Q360 0 720 40 T1440 40 V80 H0 V40 Z"
              fill="url(#gradient1)"
            />
            <defs>
              <linearGradient
        ...
        <div className="section-divider">
          ...
          >
            <path
              d="M0 40 Q360 80 720 40 T1440 40 V0 H0 V40 Z"
              fill="url(#gradient2)"
            />
            <defs>
              <linearGradient
        ...
        <button
          ...
          className="fixed bottom-6 right-6 z-50 bg-gradient-to-br from-purple-600 to-fuchsia-600 text-white p-4 rounded-full shadow-lg hover:scale-105 transition"
        >
          <FaComments size={24} />
        </button>
        ...
        {/* ✅ Chatbot Popup */}
        {isOpen && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-start justify-center pt-15 px-4">
            <div className="relative w-full max-w-xl mx-auto">
              <button
                onClick={() => setIsOpen(false)}
                className="absolute top-4 right-4 w-10 h-10 bg-gradient-to-br from-purple-500 to-fuchsia-600 text-white hover:scale-110 transition-transform duration-150 rounded-full shadow-lg z-50 flex items-center justify-center"
                aria-label="Close"
              >
                ✖
              </button>
