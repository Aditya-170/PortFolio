...
export default function GeminiChatBot() {
  ...
  return (
    <motion.div
      ...
      style={{ position: "absolute", top: "100px", left: "100px", zIndex: 999 }}
      className="backdrop-blur-lg bg-white/70 dark:bg-purple-950/60 border border-purple-200 dark:border-purple-700 drop-shadow-[0_0_10px_rgba(168,85,247,0.4)] rounded-3xl p-6 w-[95vw] sm:w-[400px] max-h-[90vh]"
    >
        ...
        <AnimatePresence>
          {messages.map((msg, index) => (
            <motion.div
              ...
              className={`p-3 rounded-2xl max-w-[80%] break-words text-sm whitespace-pre-line ${
                msg.type === "user"
